...
function ActionsCell({ expense }: { expense: PersonalExpenseRow }) {
  ...
  return (
    <button
      ...
      className="inline-flex items-center justify-center rounded-[6px] text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring hover:bg-[#f5f7f6] hover:text-[#0b100e] text-[#68726d] h-8 w-8 cursor-pointer"
      onClick={handleClick}
    >
