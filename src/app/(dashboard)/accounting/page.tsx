    ...
    <div className="space-y-5 pb-8">
      <section className="flex flex-col gap-5 border-b border-black/[0.07] pb-5 pt-1 xl:flex-row xl:items-end xl:justify-between">
        <div className="max-w-2xl">
          <p className="text-[10px] font-semibold uppercase tracking-[0.16em] text-[#0b8f7d]">Finance operations</p>
          <h1 className="mt-1.5 text-[25px] font-semibold tracking-[-0.035em] text-[#10231d] md:text-[28px]">Accounting control center</h1>
